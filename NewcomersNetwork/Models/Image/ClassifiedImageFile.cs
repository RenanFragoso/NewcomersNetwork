...
{
    public class ClassifiedImageFile : IImageFile
    {
        ...
        public ClassifiedImageFile()
        {
            this.Container = "users";
        }

        public ClassifiedImageFile(string fileName, int fileSize, string contentType)
        {
            this.Container = "classifieds";
